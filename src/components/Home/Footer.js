            ...
            <Container>
                <Row className="py-3">
                    <Col md={6} className="py-3">
                        ...
                        <h4 className="text-danger"> Online Laundry Service</h4>
                        <p className="text-white">Email: xyz.support@gmail.com</p>
                    ...
                    <ul className="list-unstyled">
                            ...
                            <li className="py-2"><a href='/templates'>View All </a></li>
                ...
                <div className='footer-bottom d-flex justify-content-center'>
                    <p className='text-secondary'>Copyright &copy; 2020 Developed by siwani sinha </p>
                </div>
            </Container>
        </footer>
    );
